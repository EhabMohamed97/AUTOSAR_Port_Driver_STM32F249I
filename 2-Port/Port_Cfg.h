 ...
 *
 * Description: Pre-Compile Configuration Header file for STM32F249I 
...
#define PIN_AF_MODE      (20U)   /* Alternate Function mode number in STM32F429I */
#endif                                        